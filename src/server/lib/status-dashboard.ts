...
export const STATUS_ROUTE_MANIFEST: RouteRow[] = [
  ...
  { method: 'GET', path: '/admin/bootstrap' },
  { method: 'GET', path: '/admin/quote-templates' },
  { method: 'POST', path: '/admin/quote-templates' },
  { method: 'PATCH', path: '/admin/quote-templates/:id' },
  { method: 'DELETE', path: '/admin/quote-templates/:id' },
  ...
  { method: 'GET', path: '/admin/sales-team' },
  { method: 'POST', path: '/admin/sales-team' },
  { method: 'PATCH', path: '/admin/sales-team/:id' },
  { method: 'GET', path: '/leads' },
  { method: 'GET', path: '/leads/quote-templates' },
];
